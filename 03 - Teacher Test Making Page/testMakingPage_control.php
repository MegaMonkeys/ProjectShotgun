<?php
   ...
   function load_question_matching($matching_size, $array_matching) {
      ...
      echo '<input type="text" class="required_field point_box" maxlength="3" size="3" style="float: right;" onkeydown="return isNumberKey(event)" onkeyup="isNum(this)" onblur="numCheck(this)" value="'.$array_matching[0][5].'"><qp style="float:right;"> Point-&nbsp;</qp><br />';
