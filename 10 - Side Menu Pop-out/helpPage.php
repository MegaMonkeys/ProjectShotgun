   ...
   <div class="container" >
    ...
    <div class="contents" >
		<div class="in-contents">
		  ...
		  <hr>
		  <a href="./user_manual.pdf" download>Download user manual</a><br /><br />
            ...
            <h3><span id="questiontitle">Q: What happens if I click the "I cheated" button?</span></h3>
				<div><p>A: You will get a zero on your test. If you accidentally click the button, please contact your teacher.</p></div>
			</div>
